...
Shrinky publishes unsigned macOS beta builds on the GitHub [Releases page](https://github.com/rbmrs/shrinky/releases).

## Downloading

1. Open the latest pre-release.
2. Download `Shrinky-*-macos.zip`.
3. Unzip it and move `Shrinky.app` wherever you keep apps.
4. On first launch, right-click `Shrinky.app` and choose **Open** to bypass Gatekeeper for the unsigned beta build.
...
3. Packages `Shrinky.app` as `Shrinky-<version>-macos.zip`.
